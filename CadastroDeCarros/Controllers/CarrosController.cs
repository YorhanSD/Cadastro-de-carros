...
namespace CadastroDeCarros.Controllers
{
    public class CarrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Marca,Ano,Motor,Turbo")] Carros carros)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Marca,Ano,Motor,Turbo")] Carros carros)
        {
            if (id != carros.Id)
            {
                return NotFound();
